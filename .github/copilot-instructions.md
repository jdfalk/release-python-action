...
<!-- version: 1.1.0 -->
<!-- guid: e1f2a3b4-c5d6-7890-e678-901234567890 -->
...
- All changes to Python release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that builds and releases Python packages to PyPI.
